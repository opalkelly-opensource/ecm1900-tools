...
def preConfiguration(i2cdev):
    ...
    i2cWrite8(i2cdev, i2cAddr1, 0x06, 0x01) #Enable V1, V2 Differential
    i2cWrite8(i2cdev, i2cAddr1, 0x07, 0x10) #Enable V7, V8 Differential
    i2cWrite8(i2cdev, i2cAddr1, 0x08, 0x10) #Enable Repeated Acquisition 
    i2cWrite8(i2cdev, i2cAddr1, 0x01, 0xf8) #Enable all channels
    i2cWrite8(i2cdev, i2cAddr1, 0x08, 0x10 | 0x08) #Enable internal temperature filter
  
    i2cWrite8(i2cdev, i2cAddr2, 0x06, 0x01) #Enable V1, V2 Differential
    i2cWrite8(i2cdev, i2cAddr2, 0x07, 0x31) #Enable V5, V6 Differential, Enable V7, V8 Differential, Enable V7, V8 Temperature
    i2cWrite8(i2cdev, i2cAddr2, 0x08, 0x10) #Enable Repeated Acquisition 
    i2cWrite8(i2cdev, i2cAddr2, 0x01, 0xf8) #Enable all channels
    i2cWrite8(i2cdev, i2cAddr2, 0x07, 0x31 | 0x80) #Enable V7, V8 Filter
    i2cWrite8(i2cdev, i2cAddr2, 0x08, 0x10 | 0x08) #Enable internal temperature filter
  
    i2cWrite8(i2cdev, i2cAddr3, 0x06, 0x11) #Enable V1, V2 Differential, Enable V3, V4 Differential
    i2cWrite8(i2cdev, i2cAddr3, 0x07, 0x10) #Enable V7, V8 Differential
    i2cWrite8(i2cdev, i2cAddr3, 0x08, 0x10) #Enable Repeated Acquisition
    i2cWrite8(i2cdev, i2cAddr3, 0x01, 0xf8) #Enable all channels
    i2cWrite8(i2cdev, i2cAddr3, 0x08, 0x10 | 0x08) #Enable internal temperature filter
  
    i2cWrite8(i2cdev, i2cAddr4, 0x06, 0x11) #Enable V1, V2 Differential, Enable V3, V4 Differential
    i2cWrite8(i2cdev, i2cAddr4, 0x07, 0x10) #Enable V7, V8 Differential
    i2cWrite8(i2cdev, i2cAddr4, 0x08, 0x10) #Enable Repeated Acquisition
    i2cWrite8(i2cdev, i2cAddr4, 0x01, 0xf8) #Enable all channels
    i2cWrite8(i2cdev, i2cAddr4, 0x08, 0x10 | 0x08) #Enable internal temperature filter
...
def i2cWrite8(i2cdev, i2cAddr, reg_addr, reg_data):
    ...
    if fcntl.ioctl(i2cdev, I2C_SLAVE, i2cAddr) < 0:
...
def readSensor(i2cdev):
    ...
    buf1 = LTC2991ReadRegisterMap(i2cdev, i2cAddr1)
    buf2 = LTC2991ReadRegisterMap(i2cdev, i2cAddr2)
    buf3 = LTC2991ReadRegisterMap(i2cdev, i2cAddr3)
    buf4 = LTC2991ReadRegisterMap(i2cdev, i2cAddr4)

    sensorData = buf1 + buf2 + buf3 + buf4
